...
import aorta.app.R;
import aorta.camera.CameraSource;
import aorta.camera.CameraSourcePreview;
...
public final class BarcodeCaptureActivity extends AppCompatActivity
    ...
    private void createCameraSource(boolean autoFocus, boolean useFlash) {
        ...
        if (!barcodeDetector.isOperational()) {
            ...
            if (hasLowStorage) {
                Toast.makeText(getApplicationContext(), "low storage", Toast.LENGTH_LONG).show();
            }
        }
